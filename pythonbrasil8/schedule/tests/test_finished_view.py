...
class FinishedViewTestCase(unittest.TestCase):
    ...
    def test_template_name(self):
        self.assertEqual("schedule/finished_proposals.html", views.FinishedProposalsView.template_name)
    ...
    def test_get(self):
        ...
        self.assertEqual(views.FinishedProposalsView.template_name, resp.template_name)
