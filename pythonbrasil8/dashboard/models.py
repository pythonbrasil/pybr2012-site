...
class AccoutProfile(models.Model):
    ...
    type = models.CharField(max_length=50, choices=ATTENDANT_CHOICES)
    t_shirt = models.CharField(max_length=50, choices=T_SHIRT_CHOICES)
    ...
    profession = models.CharField(max_length=50, null=True, blank=True, choices=PROFESSION_CHOICES)
